window.linuxQuestMissions = [
    {
        ...
        story: {
            chapter: 'Глава I. Пробуждение кадета',
            intro: 'Наставница Лина приводит вас в учебный отсек Ubuntu и просит собрать свою первую мастерскую.',
            outro: 'Лина одобрительно кивает: «Ты построил базу. Дальше будет только интереснее».'
        },
        reward: {
            id: 'badge-foundation',
            title: 'Бейдж «Ученик терминала»',
            description: 'Подтверждает, что вы уверенно ориентируетесь в оболочке и ведёте учебный журнал.',
            hint: 'Соберите мастерскую и заполните дневник, чтобы заслужить доверие наставницы.'
        },
        npc: {
            id: 'mentor-lina',
            name: 'Наставница Лина',
            intro: 'Лина наблюдает за каждым шагом и даёт мягкие подсказки, когда вы приближаетесь к цели.'
        },
        tasks: [
            {
                title: 'Кто у пульта?',
            ...
            {
                title: 'Отследить записи наставницы',
                description: 'Выведите строки дневника с пометкой «День».',
                learning: 'grep -n показывает номера строк вместе с совпадениями.',
                context: 'Лина оставляет в дневнике скрытые пометки для будущих миссий.',
                command: 'grep -n "День" проекты/дневник.md',
                response: 'Номера строк подсветили записи наставницы.',
                success: 'Вы нашли ритм обучения и готовы к новым подсказкам.',
                explanation: 'Флаг -n пригодится при поиске ошибок в логах и конфигурациях.',
                hintKey: 'grep -n',
                storyBeat: '«Числа — твой компас, кадет. Отмечай прогресс каждый день», — напоминает Лина.'
            }
        ]
    },
    {
        ...
        story: {
            chapter: 'Глава II. Карта архива',
            intro: 'Архивариус Рэй доверил вам ключи к хранилищу и просит навести порядок в проектах.',
            outro: 'Рэй доволен: «Архив блестит. Теперь мы можем двигаться к разведке системы».'
        },
        reward: {
            id: 'badge-navigator',
            title: 'Бейдж «Архивариус»',
            description: 'Доказательство, что вы умеете очищать данные и готовить их к анализу.',
            hint: 'Проведите ревизию файлов и подготовьте архив, чтобы заслужить благодарность Рэя.'
        },
        npc: {
            id: 'archivist-ray',
            name: 'Архивариус Рэй',
            intro: 'Рэй заботливо курирует хранилище и ждёт, что вы выявите хаос в проектах.'
        },
        tasks: [
            {
            ...
            {
                title: 'Подсчитать строки отчёта',
                description: 'Узнайте, сколько записей содержит файл результатов.',
                learning: 'wc -l считает строки и выводит имя файла.',
                context: 'Рэй оценивает объём данных перед дальнейшей обработкой.',
                command: 'wc -l Документы/результаты.csv',
                response: 'Число строк получено.',
                success: 'Теперь известно, сколько записей предстоит разобрать.',
                explanation: 'Используйте этот приём перед фильтрацией, чтобы видеть масштаб задачи.',
                hintKey: 'wc -l',
                storyBeat: '«Сначала оцени поле боя — узнай количество строк, и только потом действуй», — советует Рэй.'
            },
            {
    ...
    },
    {
        ...
        story: {
            chapter: 'Глава III. Разведка системы',
            intro: 'Аналитик Айша просит обследовать журналы Ubuntu и найти закономерности в данных.',
            outro: 'Айша отмечает: «Ты читаешь журналы как карту. Время переходить к управлению сервисами».'
        },
        reward: {
            id: 'badge-explorer',
            title: 'Бейдж «Системный разведчик»',
            description: 'Показывает, что вы умеете находить сигналы в массивах логов.',
            hint: 'Проанализируйте журналы и оптимизируйте списки, чтобы заслужить уважение Айши.'
        },
        npc: {
            id: 'analyst-aisha',
            name: 'Аналитик Айша',
            intro: 'Айша делится разведданными и ждёт, что вы подтвердите её гипотезы в логах.'
        },
        tasks: [
            {
                title: 'Найти журналы',
            ...
            },
            {
                ...
                hintKey: 'grep -i',
                storyBeat: 'Айша просит выписать ошибки, чтобы понять, откуда началась аномалия.'
            },
            {
            ...
            },
            {
                ...
                hintKey: 'sort -u',
                storyBeat: 'Айша отмечает, что чистые списки ускорят работу автоматизации.'
            },
            {
    ...
    },
    {
        ...
        story: {
            chapter: 'Глава IV. Сердце сервисов',
            intro: 'Инженер Марк приглашает вас в машинный зал, чтобы доверить управление критичными сервисами.',
            outro: 'Марк улыбается: «Сервисы в безопасности. Пора готовиться к развёртыванию».'
        },
        reward: {
            id: 'badge-operator',
            title: 'Бейдж «Хранитель сервисов»',
            description: 'Подтверждает, что вы уверенно управляете процессами и службами Ubuntu.',
            hint: 'Поддержите nginx и систему обновлений, чтобы заслужить уважение Марка.'
        },
        npc: {
            id: 'engineer-mark',
            name: 'Инженер Марк',
            intro: 'Марк следит за uptime и рассчитывает на вашу дисциплину в управлении службами.'
        },
        tasks: [
            {
            ...
            },
            {
                ...
                hintKey: 'journalctl',
                storyBeat: 'Марк просит удостовериться, что после перезапуска нет тревожных записей.'
            },
            {
    ...
    },
    {
        ...
        story: {
            chapter: 'Глава V. Штаб развёртываний',
            intro: 'Координатор Наоми подключает вас к цепочке CI/CD и поручает контролировать релиз.',
            outro: 'Наоми отмечает: «Релиз закрыт без сбоев. Осталось обезопасить рубежи».'
        },
        reward: {
            id: 'badge-devops',
            title: 'Бейдж «Мастер релиза»',
            description: 'Показывает, что вы держите под контролем Git, контейнеры и автоматизацию.',
            hint: 'Соберите стек, проверьте логи и задеплойте обновление, чтобы впечатлить Наоми.'
        },
        npc: {
            id: 'coordinator-naomi',
            name: 'Координатор Наоми',
            intro: 'Наоми следит за темпом релизов и ожидает безупречной координации команд.'
        },
        tasks: [
            {
            ...
            },
            {
                ...
                storyBeat: 'Наоми кивает: «Без живого окружения мы не увидим, как поведёт себя релиз».'
            },
            {
            ...
            },
            {
                ...
                storyBeat: 'Наоми отмечает: «Автоматизация спасает время — главное контролировать журнал выполнения».'
            },
            {
    ...
    },
    {
        ...
        story: {
            chapter: 'Глава VI. Осада Спектра',
            intro: 'В логах замечена активность хакера по прозвищу Спектр. Ваша задача — выявить атаки и перекрыть каналы.',
            outro: 'Спектр отступает. Вы доказали, что умеете защищать Ubuntu от реальных угроз.'
        },
        reward: {
            id: 'badge-guardian',
            title: 'Бейдж «Страж Ubuntu»',
            description: 'Подтверждает владение защитой сервисов, файлами и журналами доступа.',
            hint: 'Найдите следы Спектра и перекройте им путь, чтобы заслужить этот титул.'
        },
        npc: {
            id: 'specter',
            name: 'Хакер Спектр',
            intro: 'Неуловимый противник прощупывает SSH — отслеживайте его шаги в журналах и файерволе.'
        },
        tasks: [
            {
            ...
            },
            {
                ...
                hintKey: 'ufw enable',
                storyBeat: 'Спектр чувствует, что щиты поднимаются — скорость атаки снижается.'
            },
            {
                title: 'Проверить auth.log',
                description: 'Просмотрите последние строки auth.log в поисках следов Спектра.',
                learning: 'tail -n NUM показывает хвост файла.',
                context: 'Журнал авторизации хранит первые подсказки о нападении.',
                command: 'sudo tail -n 20 /var/log/auth.log',
                alternatives: ['tail -n 20 /var/log/auth.log'],
                response: 'Свежие события авторизации показаны.',
                success: 'Вы обнаружили в хвосте журнала подозрительные попытки входа.',
                explanation: 'tail помогает быстро увидеть последние события без открытия всего файла.',
                hintKey: 'tail',
                storyBeat: 'Вы замечаете подпись Спектра в последних строках auth.log.'
            },
            {
                title: 'Найти неудачные входы',
                description: 'Отфильтруйте неудачные попытки входа в auth.log.',
                learning: 'grep ищет строки, содержащие шаблон.',
                context: 'Важно понять, сколько попыток совершил противник.',
                command: 'sudo grep "Failed password" /var/log/auth.log',
                alternatives: ['grep "Failed password" /var/log/auth.log', 'sudo grep -i "Failed password" /var/log/auth.log'],
                response: 'Список неудачных входов выведен.',
                success: 'Все попытки перебора паролей видны и записаны.',
                explanation: 'Комбинируйте с -c, чтобы узнать, сколько раз встречается шаблон.',
                hintKey: 'grep -i',
                storyBeat: 'Спектр пытался войти десятки раз — это подтверждает атаку.'
            },
            {
                title: 'Заблокировать IP атакующего',
                description: 'Добавьте правило deny для IP 185.199.108.133.',
                learning: 'sudo ufw deny запрещает доступ по адресу или порту.',
                context: 'Нужно перекрыть источник атак.',
                command: 'sudo ufw deny 185.199.108.133',
                alternatives: ['ufw deny 185.199.108.133'],
                response: 'Правило deny создано.',
                success: 'IP атакующего добавлен в чёрный список UFW.',
                explanation: 'По IP можно мгновенно перекрыть канал злоумышленника.',
                hintKey: 'ufw deny',
                storyBeat: 'Спектр лишается доступа — его IP заблокирован.'
            },
            {
                title: 'Убедиться в статусе UFW',
                description: 'Проверьте активные правила файервола.',
                learning: 'ufw status выводит текущие правила.',
                context: 'После добавления deny нужно убедиться, что правило применено.',
                command: 'sudo ufw status',
                alternatives: ['ufw status'],
                response: 'Статус и список правил выведены.',
                success: 'Вы подтверждаете, что нужные правила активны.',
                explanation: 'Режим verbose покажет IPv6 и дополнительные детали.',
                hintKey: 'ufw status',
                storyBeat: 'Отчёт UFW подтверждает: защита держит Спектра на расстоянии.'
            },
            {
                ...
                hintKey: 'fail2ban',
                storyBeat: 'Fail2ban показывает, что Спектр уже попал в карантин.'
            },
            {
